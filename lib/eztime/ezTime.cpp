...
void Timezone::setEZTime(const time_t t, const uint16_t ms /* = 0 */) {
	int16_t offset;
	offset = getOffset(t);
...
void Timezone::setEZTime(const uint8_t hr, const uint8_t min, const uint8_t sec, const uint8_t day, const uint8_t mnth, uint16_t yr) {
	tmElements_t tm;
...
namespace ezt {
	...
	void setEZTime(const uint8_t hr, const uint8_t min, const uint8_t sec, const uint8_t day, const uint8_t month, const uint16_t yr) { defaultTZ->setEZTime(hr, min, sec, day, month, yr); }
	void setEZTime(time_t t) { defaultTZ->setEZTime(t); }
