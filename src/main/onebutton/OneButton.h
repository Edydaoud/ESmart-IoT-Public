...
extern "C"
{
  ...
  using callbackFunction = std::function<void(int, String)>; // <======= replace dumb function pointer by std::function
...
public:
   ...
   */
  OneButton(int pin, String id, boolean activeLow = true, bool pullupActive = true);
...
private:
  ...
  String _id;                       // hardware pin number.
